...
ancs=$(sed 1d /mnt/project/data/ldmatrix2/missing_blocks2.txt | awk '{print $4}' | sort | uniq | tr '\n' ' ')
ancs=(`echo $ancs`)
...
do
    ...
    awk -v chr="$chr" -v anc="$anc" '{if($1 == chr && $4 == anc) {print $0}}' /mnt/project/data/ldmatrix2/missing_blocks2.txt > ld_regions.tsv
